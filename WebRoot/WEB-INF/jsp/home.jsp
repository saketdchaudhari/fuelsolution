...
<form method="post" action="#" onkeypress="javascript:return window.WebForm_FireDefaultButton(event, 'ctl00_DoNothing')" id="ctl00_form1" >
        ...
        <td style="width: 100%;" valign="top" bgcolor="#0066A1">
            ...
            <tbody><tr>
                ...
                <td valign="top" style="text-transform: capitalize; text-align: left; width:240px ">
                    ...
                    <label id="Labeld" class="eaclabel" style="font-weight:bold; color:White; text-transform: capitalize; text-align: left; padding-top: 5px;">Date &amp; Time : 21-May-2015  12:39:37 </label></td>
            ...
            <tbody><tr>
                ...
                <table cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td align="left">
                     <ul id="css3menu1" style="width: 99%">
                        <li class="topmenu"><a id="ctl00_a1" title="Home" href="Home.jsp" style="width: 70px;">HOME</a></li>
                        <li class="topmenu"><a id="ctl00_aa1" style="width: 70px;">STATUS</a>
                            <ul>
	                            <li><a id="ctl00_a2" title="Live Pump Status" href="Status.Station.jsp" style="width: 100px;">PUMP STATUS</a></li>
	                            <li><a id="ctl00_a3" title="Live Tank Status" href="#">TANK STATUS</a></li>
	                            <li><a id="ctl00_a4" title="Device Status" href="#">DEVICE STATUS</a></li>
	                            <li><a id="ctl00_a5" title="Point of Sale(POS)" href="javascript:void(0);#" >PUMP CONTROL</a></li>	
	                            <!--  onclick="PopupCenter('../Web_Page/Pump_Preset.aspx');"-->	                
                            </ul></li>
                        ...
                        <li style="border:none;"><a id="ctl00_aa4" style="text-transform: uppercase; width: 110px;">Configuration</a>
                            <ul>
	                            <li><a id="ctl00_a51" title="Station Configuration" href="Configuration_Config.jsp" style="width: 100px;">STATION</a></li>
                ...
                <td>
                    <table cellpadding="0" cellspacing="0" width="100%">
                        <tbody><tr>
                            ...
                            <td height="23px">
                                <span id="ctl00_SiteMapPath1" class="eaclabel" style="color:#0066A1;font-weight:bold;"><a href="#ctl00_SiteMapPath1_SkipLink"><img alt="Skip Navigation Links" height="0" width="0" src="/WebResource.axd?d=j%2fX6yCEQONs2Z7JEQwAdt1KUX%2fB6%2f8f2frZzMWaCTe8%3d_Cyyz8%2fApJatOzNlD5Ib2TEOT8UgPhavOTLFeKAvYWMQ%3d_f&amp;t=634979298260000000" style="border-width:0px;"></a><span class="eaclabel" style="color:#0066A1;text-decoration:none;">Home</span><a id="ctl00_SiteMapPath1_SkipLink"></a></span>
...
<table style="width: 100%; height : 540px; vertical-align: top; " cellpadding="0" cellspacing="0">
    <tbody><tr>        
    <td align="center" valign="middle"> 
        <img id="ctl00_ContentPlaceHolder1_leftContent" src="Images/Body.png" style="height: 500px; width: 921px;">						    
    </td>
    </tr>
    </tbody></table>    
...
<div id="ctl00_pump_Panel" class="modalBox" style="height: 360px; width: 415px; display: none; position: fixed; z-index: 100001; left: 681px; top: 446px;">
...
<div id="mpe_backgroundElement" class="modalBackground" style="display: none; position: fixed; left: 0px; top: 0px; z-index: 10000; width: 1362px; height: 1109px;"></div>
...
<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="">
</div>
...
Sys.Application.add_init(function() {
	$create(AjaxControlToolkit.ModalPopupBehavior, {"BackgroundCssClass":"modalBackground","CancelControlID":"ctl00_ImageButton6","dynamicServicePath":"/Web_Page/Home_Page.aspx","id":"mpe","PopupControlID":"ctl00_pump_Panel"}, null, null, $get("ctl00_Button28"));
});
//]]></script>
</form>
</body>
